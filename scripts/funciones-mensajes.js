    ...
    return {
        ...
        curpValidacion(curp) {
            ...
            if (curp.length !== 18) {
                ...
                this.ingresoManualMensaje(curp);
            }
        },
        ...
        enviarNotificacionPush:function(curp, mensaje) {
            const options = {
            method: 'POST',
            headers: {
            ...
            fetch(`https://api.sisedugob.com/mensaje-notificacion`, options)
        ...
        ingresoManualMensaje(curp) {
        Swal.fire({
            title: "Ingresa Mensaje del alumno",
            input: "text",
            inputAttributes: { autocapitalize: "off" },
            showCancelButton: true,
            confirmButtonText: "Enviar",
            ...
            customClass: {
                ...
                if (result.isConfirmed) {
                    this.resultadoEscaneo = result.value
                    this.enviarNotificacionPush(curp, this.resultadoEscaneo);
                }
          });
        }
}}